...
library IncrementalBinaryTree {
    ...
    function update(
        ...
        require(index < self.numberOfLeaves, "IncrementalBinaryTree: leaf index out of range");
        require(
            verify(self, leaf, proofSiblings, index),
    ...
    function remove(
        ...
        update(self, leaf, self.useDefaultZeroes ? Z_0 : self.zeroes[0], proofSiblings, index);
    }
